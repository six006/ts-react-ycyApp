...
type props = {
    locationInfo: tApp.locationInfo
};
type state = {
    activeList?: tScene.activeList,
    goodsTopTypeList?: tScene.goodsTypeList,
    goodsTopTypeSelectId?: string,
    goodsLeftTypeList?: tScene.goodsTypeList,
    goodsLeftTypeSelectId?: string,
    goodsList?: tScene.goodsList,
        ...
        return f.Request.getGoodsTypeList({ pid: '0' }).then(
            (topTypeList: tScene.goodsTypeList) => {
                ...
                return f.Request.getGoodsTypeList({ pid: selectId }).then(
                    (leftTypeList: tScene.goodsTypeList) => {
